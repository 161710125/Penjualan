                ...
                {{csrf_field()}} {{ method_field('POST') }}
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label>Merk :</label>
                        <input type="text" name="merk" id="merk" class="form-control" placeholder="Adidas" />
                        <span class="help-block has-error merk_error"></span>
                     </div>

                     <div class="form-group">
                        <label>Harga Satuan :</label>
                        <input type="text" name="harga_satuan" id="harga_satuan" class="form-control" placeholder="John Bred" />
                        <span class="help-block has-error harga_satuan_error"></span>
                     </div>

                     <div class="form-group">
                        <label>Stok :</label>
                        <input type="number" name="stok" id="stok" class="form-control" placeholder="John Bred" />
